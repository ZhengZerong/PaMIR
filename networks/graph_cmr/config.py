...
COCO_ROOT = ''
UP_3D_ROOT = ''
TWINDOM_ROOT = '/media/zerong/storage03/PIFU/twindom_dataset/image_data_uniform_lighting_60views'
...
DATASET_FILES = [ {'h36m-p1': join(DATASET_NPZ_PATH, 'extras', 'h36m_valid_protocol1.npz'),
                  ...
                  {'lsp-orig': join(DATASET_NPZ_PATH, 'extras', 'lsp_dataset_original_train.npz'),
                   ...
                   'twindom': join(DATASET_NPZ_PATH, 'extras', 'twindom_train.npz'),
                   }
                ]
